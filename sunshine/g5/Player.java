...
//    {
//
//          if(Math.abs(tractor.getLocation().x-0)<1e-1 && Math.abs(tractor.getLocation().y-0)<1e-1){
...
//
//          }
//          if(Math.abs(tractor.getLocation().x-length/2)<0.11 && Math.abs(tractor.getLocation().y-length/2)<0.11){
//              if(tractor.getAttachedTrailer()!=null){
...
//                  return Command.createMoveCommand(p);
//              }
//              if(!fill[tractor.getId()] && (tractor.getHasBale() && (count%10==0 ||count%10==CollectBales))){
//
...
//              return Command.createMoveCommand(p);
//          }else{
//              if(Math.abs(tractor.getLocation().x-bales.get(0).x)<1e-3 && Math.abs(tractor.getLocation().y-bales.get(0).y)<1e-3){
